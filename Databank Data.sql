...
SELECT region_name, 
		COUNT(DISTINCT customer_Id) AS custmer_count
FROM updated_customer_nodes
GROUP BY region_name;
-- "Africa"	102
-- "America"	105
...
-- Let's join the transaction to update customer nodes
CREATE TABLE updated_customers AS 
SELECT updated_customer_nodes.customer_Id,
		updated_customer_nodes.region_name,
		updated_customer_nodes.node,
		updated_customer_nodes.start_date,
		updated_customer_nodes.end_date,
		customer_transactions.txn_date,
		customer_transactions.txn_type,
		customer_transactions.txn_amount
FROM updated_customer_nodes
JOIN customer_transactions
ON updated_customer_nodes.customer_Id = customer_transactions.customer_Id
	AND customer_transactions.txn_date BETWEEN updated_customer_nodes.start_date AND updated_customer_nodes.end_date
ORDER BY updated_customer_nodes.customer_Id;
...
GROUP BY node;
-- "Full node"	629007
-- "Lightning nodes"	622026
-- "Distributed Node"	555840
-- "Light nodes"	596971
-- "Masternodes"	554171
...
-- What are the transaction amount per region and node?
SELECT region_name,
		node,
		SUM(txn_amount) AS total_txn_amount
FROM updated_customers
...
-- "Africa"	"Light nodes"	119727
-- "Africa"	"Lightning nodes"	125635
-- "Africa"	"Full node"	119071
-- "Africa"	"Distributed Node"	125250
-- "Africa"	"Masternodes"	114407
-- "America"	"Distributed Node"	132694
-- "America"	"Light nodes"	105235
-- "America"	"Full node"	143989
-- "America"	"Masternodes"	107231
-- "America"	"Lightning nodes"	140319
-- "Asia"	"Lightning nodes"	131994
-- "Asia"	"Masternodes"	107725
-- "Asia"	"Light nodes"	116558
-- "Asia"	"Full node"	137960
-- "Asia"	"Distributed Node"	85460
-- "Australia"	"Light nodes"	155751
-- "Australia"	"Distributed Node"	126779
-- "Australia"	"Full node"	125224
-- "Australia"	"Masternodes"	115330
-- "Australia"	"Lightning nodes"	135740
-- "Europe"	"Light nodes"	99700
-- "Europe"	"Masternodes"	109478
-- "Europe"	"Distributed Node"	85657
-- "Europe"	"Full node"	102763
-- "Europe"	"Lightning nodes"	88338
